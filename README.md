...
5. Run this command once installation is complete `php artisan migrate && php artisan db:seed && php artisan serve` or `sail artisan migrate && sail artisan db:seed && sail artisan serve`
